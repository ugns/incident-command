...
resource "aws_api_gateway_deployment" "incident_cmd" {
  ...
  depends_on = flatten([
    ...
    values(aws_api_gateway_integration.incidents_methods),
    values(aws_api_gateway_integration.incidents_id_methods),
    [aws_api_gateway_integration.incidents_options],
    [aws_api_gateway_integration.incidents_id_options],
    values(aws_api_gateway_integration.units_methods),
    values(aws_api_gateway_integration.units_id_methods),
