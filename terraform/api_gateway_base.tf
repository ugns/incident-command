...
resource "aws_api_gateway_deployment" "incident_cmd" {
  ...
  depends_on = [
    ...
    aws_api_gateway_integration.incidents_methods["GET"],
    aws_api_gateway_integration.incidents_methods["POST"],
    aws_api_gateway_integration.incidents_id_methods["GET"],
    aws_api_gateway_integration.incidents_id_methods["PUT"],
    aws_api_gateway_integration.incidents_id_methods["DELETE"],
    aws_api_gateway_integration.incidents_options,
    aws_api_gateway_integration.incidents_id_options,
    aws_api_gateway_integration.units_methods["GET"],
    aws_api_gateway_integration.units_methods["POST"],
    aws_api_gateway_integration.units_id_methods["GET"],
    aws_api_gateway_integration.units_id_methods["PUT"],
    aws_api_gateway_integration.units_id_methods["DELETE"],
    aws_api_gateway_integration.units_options,
    aws_api_gateway_integration.units_id_options,
    aws_api_gateway_integration.locations_methods["GET"],
    aws_api_gateway_integration.locations_methods["POST"],
    aws_api_gateway_integration.locations_id_methods["GET"],
    aws_api_gateway_integration.locations_id_methods["PUT"],
    aws_api_gateway_integration.locations_id_methods["DELETE"],
    aws_api_gateway_integration.locations_options,
    aws_api_gateway_integration.locations_id_options,
    aws_api_gateway_integration.radios_methods["GET"],
    aws_api_gateway_integration.radios_methods["POST"],
    aws_api_gateway_integration.radios_id_methods["GET"],
    aws_api_gateway_integration.radios_id_methods["PUT"],
    aws_api_gateway_integration.radios_id_methods["DELETE"],
    aws_api_gateway_integration.radios_options,
    aws_api_gateway_integration.radios_id_options
  ]
}
